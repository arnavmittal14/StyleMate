...
urlpatterns = [
    ...
    path("api/get_saved_outfits/", views.get_saved_outfits,
         name="get_saved_outfits"),
    path("api/get_closet/", views.get_closet, name="get_closet"),
    path("api/delete_from_closet/", views.delete_from_closet,
         name="delete_from_closet"),
    path("api/get_users/", views.get_users, name="get_users"),
    path("api/upload_and_process_photo/", views.upload_and_process_photo,
         name="upload_and_process_photo"),
    path("api/ai/", include("ai_processor.urls")),
    path("api/current_user/", views.current_user, name="current_user"),
    path("api/guest_login/", views.guest_login, name="guest_login"),
    path("api/profile_photo/<int:user_id>/",
         views.serve_profile_photo, name="serve_profile_photo"),
    path("api/update_user/", views.update_user, name="update_user"),
    path("api/serve_clothing_item/<int:item_id>/",
         views.serve_clothing_item, name="serve_clothing_item"),
